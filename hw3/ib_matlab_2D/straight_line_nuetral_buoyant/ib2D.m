...
video=VideoWriter(['mov/straight_line_nb_theta=',num2str(theta0),'_Lp=',num2str(Lp),...
...
%     omega_half=omega+dt/2/I0*tau_half;
    ...
    ff=spread(Force(XX),XX); %To Check;Force density or discrete Force?
